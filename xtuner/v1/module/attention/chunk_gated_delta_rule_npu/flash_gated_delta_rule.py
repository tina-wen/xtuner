...
def flash_chunk_gated_delta_rule_fwd(
    ...
    chunk_indices1: Optional[list[int]] = None,
    chunk_size: int = 64,
):
...
def flash_chunk_gated_delta_rule_bwd(
    ...
    dg = chunk_local_cumsum(dg, chunk_size=chunk_size, reverse=True, cu_seqlens=cu_seqlens, chunk_indices=chunk_indices, head_first=False)
...
class ChunkGatedDeltaRuleFunction(torch.autograd.Function):
    ...
    def forward(
        ...
        ctx.chunk_indices1 = chunk_indices1
        ctx.scale = scale
    ...
    def backward(
        ...
        chunk_indices1 = ctx.chunk_indices1
